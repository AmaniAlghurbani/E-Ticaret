    ...
    public class DataInitializer : DropCreateDatabaseIfModelChanges<DataContext>
    {
        protected override void Seed(DataContext context)
        {
            ...
            var urunler = new List<Product>()
            {
                ...
                new Product(){ Name = "Kolye",Description = "Altıntaç 0,42 Karat Elmas Kolye 10893-PKL0005, Ürün Kodu 10893-PKL0005.", Price =16000 , Stock =5 , IsApproved =false , CategoryId = 1,IsHome = true,Image = "3elmas.jpg"},
                ...
                new Product(){ Name = "K14 Ayar Altın Bilezik",Description = " En uygun Fiyat Garantisiyle, Peşin fiyatına taksitle, Stoktan aynı gün kargoyla güvenli alışverişin adresi Bilezikci.com .", Price =16400 , Stock =0 , IsApproved =false , CategoryId = 2,IsHome = true,Image = "6altın.jpg"},
                ...
                new Product(){ Name = "Gümüş Bayan Set",Description = " Gümüş ve zirkon taşının ışıltısı dünyanıza renk katacak ve yaşam enerjinizi artıracak. Zirkonun göz alıcı parıltısı dört sıra taş ile doğanın ...", Price =2320 , Stock =2 , IsApproved =false , CategoryId =3,IsHome = true,Image = "1gümüş.jpg"},
                new Product(){ Name = "Parlak Gümüş Yüzüğü",Description = "Söz Yüzüğü gümüş alyans çiftimiz, sözlenecek, söz töreni yapacak veya kendi aralarında söz verecek olan müşterilerimizin yoğunlukla tercih ettiği . .", Price =3400 , Stock =0 , IsApproved =false , CategoryId =3,IsHome = true,Image = "2gümüş.jpg"},
                new Product(){ Name = "Nişan Gümüş Yüzük",Description = "ürününü Aliexpress'den karşılığında satın alın. Daha fazla , ve ürün bulun. ✓Dünya Çapında Ücretsiz Gönderimin Keyfini Çıkarın! ✓Sınırlı Süreli İndirim ✓Kolay İade .", Price =4900 , Stock =0 , IsApproved =false , CategoryId =3,IsHome = true,Image = "3gümüş.jpg"},
                new Product(){ Name = "Pırlanta Montür Asansörlü Gümüş Bileklik",Description = "Pırlanta Montür Asansörlü Gümüş Bileklik Hızlı ve ücretsiz kargo .", Price =2400 , Stock =0 , IsApproved =false , CategoryId =3,IsHome = true,Image = "4gümüş.jpg"},
                ...
                new Product(){ Name = "Tektaşlı Gümüş Kolye",Description = "Tektaş Damla Figürlü Swarovski Kadın Gümüş Kolye VSW-9017 en uygun fiyata .", Price =4900 , Stock =0 , IsApproved =false , CategoryId =3,IsHome = true,Image = "6gümüş.jpg"},
                ...
                new Product(){ Name = "Doğal Taş bilezik",Description = " Bileklik Taşlarından Orijinal Çakra Doğal Taş Bileklik.", Price =600 , Stock =0 , IsApproved =false , CategoryId =4,IsHome = true,Image = "3.jpg"},
